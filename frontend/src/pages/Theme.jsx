            ...
            <table className="table">
              ...
              <tbody>
                <tr className="bg-base-100">
                  ...
                  <td className="font-medium">
                    <Link to={`/problems/`} className="hover:underline">
                      <span className="line-clamp-2 break-words max-w-xs">1 Problem Title</span>
                    </Link>
                  </td>
                  <td className="text-right">55.6%</td>
                  <td className="capitalize text-success">Easy</td>
                  <td>
                ...
                <tr className="bg-base-200">
                  ...
                  <td className="font-medium">
                    <Link to={`/problems/`} className="hover:underline">
                      <span className="line-clamp-2 break-words max-w-xs">2 Problem Title</span>
                    </Link>
                  </td>
                  <td className="text-right">55.6%</td>
                  <td className="capitalize text-success">Easy</td>
