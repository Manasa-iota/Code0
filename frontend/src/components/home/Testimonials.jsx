  ...
  const testimonials = [
    {
      ...
      quote:
        "Code0 helped me prepare for my Google interview. The variety of problems and detailed solutions were invaluable.",
    },
    {
      name: "Sarah Chen",
    ...
    },
    {
      ...
      quote:
        "As a student, Code0 has been the perfect companion to my algorithms course. The reference solutions teach me new approaches.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg opacity-80 max-w-2xl mx-auto">
            ...
            with <span className="logo text-primary">Code0.</span>
          </p>
        </div>
