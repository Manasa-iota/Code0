...
export default function SettingsPage() {
  const [generalSettings, setGeneralSettings] = useState({
    ...
    contactEmail: "support@Code0.com",
    logoUrl: "/logo.png",
  ...
  const [emailSettings, setEmailSettings] = useState({
    ...
    smtpPort: 587,
    smtpUser: "notifications@code0.com",
    smtpPassword: "••••••••••••",
    senderName: "code0 Team",
    senderEmail: "notifications@code0.com",
      ...
      <div class="p-4 rounded-lg">
        <div className="mb-8">
          ...
          <p className="text-base-content opacity-70">
            Configure and customize your Code0 platform settings.
          </p>
        </div>
